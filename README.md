...
NBA Matchup Analyzer allows users to select two NBA teams and analyze their recent performance. The application fetches NBA game data from the BALLDONTLIE API, calculates recent-form metrics, and applies a rule-based scoring model to determine which team has the stronger matchup profile.

This project was built to practice Python, Flask, API integration, data processing, and backend project structure.
